...
public class WalletService {
		...
		// TODO Auto-generated method stub
		 ...
		 if(userOrder.getStatus() == Status.PENDING) {
			...
			// transactionRepository.save(transaction);
			 ...
			 integerBalance = wallet.getBalance();
			 integerBalance = integerBalance + userOrder.getNetAmount();
				Set<Wallet> walletSet = new HashSet<Wallet>();
				wallet.setBalance(integerBalance);
				wallet.setShadowBalance(integerBalance);
	...
	public Wallet walletHistory(Integer userId, String coinName) {
		...
		Wallet wallet = walletRepository.findByCoinNameAndUser(coinName, user);
		return walletRepository.getOne(wallet.getWalletId());
	}
